...
double Ellipse::area() {called = "Ellipse"; return 3.14 * r1 * r2;}
double Ellipse::perimeter() {called = "Ellipse"; return 3.14 * (r1 + r2);}
...
double Triangle::area() {called = "Triangle"; return .5 * height * width;}
...
double Trapeziod::area() {called = "Trapeziod"; return (width + width2) * .5 * height;}
...
double Parallelogram::area() {called = "Parallelogram"; return height * width;}
...
double Rhombus::area() {called = "Rhombus"; return distance(lines[0], lines[2]) * distance(lines[1], lines[4]) * .5;}
